"""
QR Code Scanner for product labels - with graceful fallback
"""
    ...
    try:
        if not HAS_CV2:
            return {
                ...
                "data": None,
                "type": "NO_CV2",
                "message": "⚠️ OpenCV not available. Demo mode active. Try uploading product labels via OCR instead!"
            }
        ...
        if data:
            ...
            return {
                ...
                "data": None,
                "type": "NO_QR",
                "message": "⚠️ No QR code detected. Try a clearer photo of the QR code."
            }
